...
CREATE TABLE clientes(
    ...
    CONSTRAINT uc_email_cliente UNIQUE(email_cliente),
...
CREATE TABLE prestamos(
    ...
    CONSTRAINT id_cliente_prestamo FOREIGN KEY(id_cliente) REFERENCES clientes(id_cliente),
    fecha_inicio DATE NOT NULL,
    fecha_devolucion DATE NOT NULL,
    CONSTRAINT chk_fecha CHECK (fecha_inicio < fecha_devolucion),
...
CREATE TABLE libros(
    ...
    CONSTRAINT id_genero_tblibro FOREIGN KEY (id_genero_libro) REFERENCES genero_libros(id_genero_libro),
...
CREATE TABLE detalles_prestamos(
	...
	CONSTRAINT id_prestamo_detalle FOREIGN KEY (id_prestamo) REFERENCES prestamos(id_prestamo),
    id_libro VARCHAR(36) NOT NULL,
    CONSTRAINT id_libro_detalle FOREIGN KEY (id_libro) REFERENCES libros(id_libro)
);